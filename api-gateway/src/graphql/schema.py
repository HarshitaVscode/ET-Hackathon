"""
GraphQL schema for Vayu-Drishti.

Provides a unified query interface for the frontend,
citizen app, and third-party integrations. Aggregates
data from all microservices behind a single GraphQL endpoint.
"""
...
class Query:
    ...
    async def aqi_forecast(
        self, city: str = "Delhi", hours: int = 72
    ) -> list[AQIForecast]:
